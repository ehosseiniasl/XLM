...
from src.data.dictionary_character import DictionaryCharacter
...
if __name__ == '__main__':
    ...
    dico = DictionaryCharacter.read_vocab(voc_path)
    logger.info("")

    data = DictionaryCharacter.index_data(txt_path, bin_path, dico)
