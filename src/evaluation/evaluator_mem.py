...
class EvaluatorMem(object):
    ...
    def evaluate_clm(self, scores, data_set, lang1, lang2):
        ...
        for batch in self.get_iterator(data_set, lang1, lang2, stream=(lang2 is None)):
            ...
            ret, word_scores = model(data=x.transpose(1, 0), target=y.transpose(1, 0), *self.mems)
...
class SingleEvaluatorMem(EvaluatorMem):
...
class EncDecEvaluatorMem(EvaluatorMem):
