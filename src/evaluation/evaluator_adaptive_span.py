...
class EvaluatorAdpSpn(object):
    ...
    def __init__(self, trainer, data, params):
        ...
        device = self.trainer.model.in_emb.weight.device
        eval_batch_size = 1
...
class SingleEvaluatorAdpSpn(EvaluatorAdpSpn):
...
class EncDecEvaluatorAdpSpn(EvaluatorAdpSpn):
